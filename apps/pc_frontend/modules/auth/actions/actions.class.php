...
class authActions extends sfActions
{
  ...
  */
  ...
  {
    $client = OpenPNEOAuth::getInstance('https://twitter.com/',Doctrine::getTable('SnsConfig')->get('awt_consumer'), Doctrine::getTable('SnsConfig')->get('awt_secret'));
  ...
  {
    $token = OpenPNEOAuth::getInstance('https://twitter.com/',  Doctrine::getTable('SnsConfig')->get('awt_consumer'),  Doctrine::getTable('SnsConfig')->get('awt_secret'))->getAccessToken($_GET['oauth_token'], $_GET['oauth_verifier']);
    //print_r($token);
